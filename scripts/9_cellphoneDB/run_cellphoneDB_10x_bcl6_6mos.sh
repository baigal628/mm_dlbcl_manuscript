...
cellphonedb method statistical_analysis 10X_format/bcl6_6mos_meta.txt 10X_format/bcl6_6mos/ --counts-data hgnc_symbol --output-path /liulab/galib/mouse_scRNAseq_margaret/data/cellphoneDB/output/bcl6_6mos_out/ --threads 16 --subsampling --subsampling-log true --subsampling-num-cells 5000
