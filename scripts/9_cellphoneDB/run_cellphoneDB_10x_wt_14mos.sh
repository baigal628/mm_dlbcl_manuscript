...
cellphonedb method statistical_analysis 10X_format/wt_14mos_meta.txt 10X_format/wt_14mos/ --counts-data hgnc_symbol --output-path /liulab/galib/mouse_scRNAseq_margaret/data/cellphoneDB/output/wt_14mos_out/ --threads 16 --subsampling --subsampling-log true --subsampling-num-cells 5000
