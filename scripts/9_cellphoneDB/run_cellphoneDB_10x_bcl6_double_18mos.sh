#!/bin/bash
#SBATCH --job-name=cellphoneDB_18mos
...
cellphonedb method statistical_analysis 10X_format/bcl6_double_18mos_meta.txt 10X_format/bcl6_double_18mos/ --counts-data hgnc_symbol --output-path /liulab/galib/mouse_scRNAseq_margaret/data/cellphoneDB/output/bcl6_double_18mos_out/ --threads 16 --subsampling --subsampling-log true --subsampling-num-cells 5000
